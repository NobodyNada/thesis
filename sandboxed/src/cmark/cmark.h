...
#define CMARK_EXPORT
#define CMARK_VERSION 123
#define CMARK_VERSION_STRING "sandbox-test"
 ...
 * ```c
 * cmark_parser_new_with_mem_into_root(options, mem,
 ...
 */
CMARK_EXPORT
cmark_parser *cmark_parser_new_with_mem_into_root(int options, cmark_mem *mem,
                                                  cmark_node *root);
